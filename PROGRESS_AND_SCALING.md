...
## Resume Fixes Needed (2026-04-23)

- Update GeoGuessr median from 672km → **617km** (Ablation C is the honest best)
- Fix **YOLOv8-pose** → **YOLO26s-pose** (wrong model name in resume)
- Remove **"Privacy-First Design"** bullet from GeoGuessr section (copy-paste from shoplifting, doesn't apply)
